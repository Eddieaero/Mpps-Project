...
import verifyline from "../../assets/verifyline.svg";
    ...
    return(
        <div>
            ...
            <div className='flex p-5' style={{borderRadius: "30px", margin: "100px 100px 100px 100px ",backgroundColor: "var(--custom-white)",width: "80%", height: "100%"}}>
                <Row>
                    <Col lg={6}>
                        <h1>Verify your business License</h1>
                    ...
                    <Col lg={6} className='flex'>
                        ...
                        <Row className='p-4 flex align-items-center justify-content-center' style={{backgroundColor: "var(--darkish-green)", width: "29rem", height: "10.75rem", borderRadius: "30px"}}>
                        ...
                        <Row className='p-4 d-flex justify-content-end'>
                            <Button className=' ' style={{border: "0px", width: "9rem", borderRadius: "22px", color: "var(--whitish-green)", backgroundColor: "var(--darkish-green)"}}>Submit</Button>
                        </Row>
                    </Col>
